    ...
    <>
      ...
      <Section className="bg-sand-50">
        <div className="flex flex-col items-end justify-between gap-6 md:flex-row">
          <SectionHeading
            title="Every industry. One trusted partner."
            description="Specialist recruiters across every sector who understand the credentials, culture, and cadence of your field."
          />
          <Reveal delay={0.1}>
